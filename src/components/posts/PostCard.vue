...
<template>
  <div class='flex items-center w-full max-w-xl my-10 bg-white shadow-md rounded-lg overflow-hidden mx-auto border-white border hover:border-gray-300'>
    <div class='w-full'>
      <div class="flex flex-row mt-2 px-2 py-3 mx-3">
          ...
          <div class="flex flex-col mb-2 ml-4 mt-1">
              <div class='text-gray-600 text-sm font-semibold text-left'>{{  }}</div>
